...
namespace Business.Services.Concrete
{
    public class ShoppingCartItemService : IShoppingCartItemService
    {
        ...
        public Task<IResult> AddToCartAsync(Guid userId, Guid productId, int count)
        {
        ...
        public Task<IResult> DecreaseItemCountAsync(Guid userId, Guid productId)
        {
            throw new NotImplementedException();
        }

        public Task<IDataResult<IEnumerable<ShoppingCartItemViewModel>>> GetAllCartItemsAsync(Guid userId)
        {
            throw new NotImplementedException();
        }

        public Task<IDataResult<ShoppingCartItem?>> GetCartItemByIdAsync(Guid itemId)
        {
            throw new NotImplementedException();
        }

        public Task<IDataResult<ShoppingCartItem?>> GetCartItemByProductIdAsync(Guid cartId, Guid productId)
        {
            throw new NotImplementedException();
        }

        public Task<int> GetTotalCartItemsAsync(Guid userId)
        {
            throw new NotImplementedException();
        }

        public Task<IResult> IncreaseItemCountAsync(Guid userId, Guid productId)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<IResult> RemoveMultipleItemsFromCartAsync(Guid userId, IEnumerable<Guid> productIds)
        {
            throw new NotImplementedException();
        }
